...
const forecast = (longitude,latitude,callback)=>{
    ...
    request({url,json:true},(error,{body})=>{
        if(error){
            ...
            callback(undefined,body.currently.time,body.currently.summary+". The temperature is "+body.currently.temperature+" F with "+body.currently.precipProbability*100+ "% probability of rain.")
        }
    })
}
